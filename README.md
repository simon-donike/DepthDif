...
![img](docs/assets/dataset_50percMask.png)  
...
![img](docs/assets/eo_dataset_example.png)
...
![img](docs/assets/95per_obstr_with_condition.png)
...
![img](docs/assets/75perc_50drop.png)
...
![img](docs/assets/95perc_50drop.png)
...
![img](docs/assets/eo_x0_maskedLoss_95perc_50percDO_EOdegradation.png)
...
<p align="center">
  <img src="docs/assets/intermediate_steps.png" alt="intermediate_steps" width="40%">
</p>
The generated images at the intermediate denoising steps have the following MAE in relation to the target:
<p align="center">
  <img src="docs/assets/mae_vs_intermediate.png" alt="mae_vs_intermediate" width="50%">
</p>
...
<p align="center">
  <img src="docs/assets/noise_schedules.png" alt="noise_schedules" width="85%">
</p>
...
- **Anchoring known pixels at inference (inpainting clamp)**  
  ...
  ![img](docs/assets/clamped_pixels.png)  
