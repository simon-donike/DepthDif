...
![img](assets/results/95per_obstr_with_condition.png)  
...
![img](assets/results/75perc_50drop.png)  
...
![img](assets/results/95perc_50drop.png)  
...
![img](assets/results/eo_x0_maskedLoss_95perc_50percDO_EOdegradation.png)  
...
Same depth levels as Exp. 5. Good reconstruction, moving on.  
![img](assets/results/97_5__streaks.png)  
...
![img](assets/results/date_coord_only.png)  
...
- compute loss only on the hidden subset (not on the full image). This is the main difference to the `ambient`-style training, where the loss is pulled over the ambient support mask `x_valid_mask ∩ y_valid_mask`.  
...
![img](assets/results/sparse_targets.png)  
...
![img](assets/results/ambient_dif_1.png)  
...
Observation:  
- works as expected  
![img](assets/results/995_synth.png)  
