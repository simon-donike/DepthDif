...
Placeholder for the first on-disk aligned baseline.

Planned setup:
- use GLORYS for both `x` and `y`
- increase the amount of sampled points to `250`
- use the on-disk aligned dataset as the starting point
