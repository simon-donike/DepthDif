...
NetCDF dataset behavior, config wiring, inference exports, and one-batch model
smoke runs.
...
Training, inference, validation-summary, and override tests protect the active
config path and `argo_netcdf_gridded` builder selection.
