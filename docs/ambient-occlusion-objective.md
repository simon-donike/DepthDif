...
![Ambient objective step-by-step example](assets/figures/ambient_occlusion_sample_ex.webp)
...
- Ambient config surface:
  - `src/depth_recon/configs/px_space/training_super_config.yaml` (`model.ambient_occlusion.*`)
