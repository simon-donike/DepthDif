...
Generated dashboard output in the hosted globe directory:
...
- generates `error-analysis.json` in the globe directory and records its URL by default
...
- `error-analysis.json`: hosted error dashboard data generated from the run's absolute-error rasters
