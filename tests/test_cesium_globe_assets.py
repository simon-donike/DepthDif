...
class TestCesiumGlobeAssets(unittest.TestCase):
    ...
    def test_standalone_globe_page_uses_full_window_root_shell(self) -> None:
        ...
        self.assertIn('id="globe-recording-panel"', html)
        self.assertIn('id="globe-recording-start"', html)
        self.assertIn('id="globe-recording-caption"', html)
        self.assertIn('params.get("recording") === "1"', globe_script)
        self.assertIn("function prepareRecordingTour", globe_script)
        self.assertIn("function runRecordingTour", globe_script)
        self.assertIn("READY TO RECORD", globe_script)
        self.assertIn("START RECORDING", globe_script)
        self.assertIn("for (let count = 5; count >= 1; count -= 1)", globe_script)
        self.assertIn("STOP RECORDING NOW", globe_script)
        self.assertIn("Temperature · GLORYS reference", globe_script)
        self.assertIn("Temperature · Depth levels", globe_script)
        self.assertNotIn("Salinity · Absolute error", globe_script)
        ...
        self.assertIn(".globe-stage.is-recording-tour", css)
        self.assertIn(".globe-recording-panel", css)
    ...
    def test_comparison_globe_page_uses_baseline_layer_controls(self) -> None:
        ...
        self.assertIn('id="globe-toggle-climatology"', html)
        self.assertIn('id="globe-toggle-lstm"', html)
        self.assertIn('id="globe-toggle-cnn"', html)
        self.assertIn('id="globe-toggle-unet"', html)
        self.assertIn('name="globe-variable"', html)
        self.assertIn('name="globe-points-layer"', html)
        self.assertIn('name="globe-patch-splits-layer"', html)
        ...
        self.assertIn('key: "climatology"', globe_script)
        self.assertIn('key: "lstm"', globe_script)
        self.assertIn('key: "cnn"', globe_script)
        self.assertIn('key: "unet"', globe_script)
        ...
        self.assertIn("cnn_tiles_url", inference_docs)
        self.assertIn("unet_tiles_url", inference_docs)
