...
class TestCesiumGlobeAssets(unittest.TestCase):
    ...
    def test_standalone_globe_page_uses_full_window_root_shell(self) -> None:
        ...
        self.assertIn('id="globe-toggle-compare"', html)
        self.assertIn('id="globe-compare-swipe"', html)
        self.assertIn('id="globe-open-tour"', html)
        self.assertIn('id="globe-tour"', html)
        self.assertIn("ARGO Locations", html)
        self.assertIn("Patches", html)
        self.assertIn('loading="lazy"', html)
        self.assertIn(".standalone-globe-root,", css)
        self.assertIn(".globe-compare-handle", css)
        self.assertIn(".globe-tour__card", css)
        ...
        self.assertIn("function setCompareMode", globe_script)
        self.assertIn("imagerySplitPosition", globe_script)
        self.assertIn("Cesium.SplitDirection.LEFT", globe_script)
        self.assertIn("TOUR_STORAGE_KEY", globe_script)
