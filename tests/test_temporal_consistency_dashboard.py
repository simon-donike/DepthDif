...
class TestTemporalConsistencyDashboard(unittest.TestCase):
    ...
    def test_temporal_dashboard_page_is_standalone_and_nav_linked(self) -> None:
        ...
        self.assertIn("Average temporal error by week", html)
        ...
        self.assertIn("function mapAreaRows", script)
        ...
        self.assertIn('mode: "lines+markers"', script)
        self.assertIn("Average error: %{y:.3f}", script)
