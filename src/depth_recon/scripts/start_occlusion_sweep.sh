#!/usr/bin/env bash
# Example:
#   src/depth_recon/scripts/start_occlusion_sweep.sh src/depth_recon/configs/px_space/sweeps/eo_occlusion_grid_no_eodrop.yaml
set -euo pipefail

WAND_BIN="/work/envs/depth/bin/wandb"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../../.." && pwd)"
DEFAULT_SWEEP_CFG="src/depth_recon/configs/px_space/sweeps/eo_occlusion_grid_no_eodrop.yaml"
